		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse">
		      <ul class="nav navbar-nav">
		        <li style="position: relative" class="office-active">
						<a href="#">Кабінет</a>
						<div class="dropdown-form">
							<div class="dropdown-form__menu">
								<div class="menu-item">
									<a href="#">First Name</a>
								</div>
								<div class="menu-item">
							...
							<div class="dropdown-form__body">
								<div class="dropdown-form__lable">
									<div class="dropdown-form__text">
										Lable
									</div>
									<input type="text" name="lable" placeholder="First Name">
								</div>
								<div class="dropdown-form__placeholder">
									<div class="dropdown-form__text">
										Placeholder
									</div>
									<input type="text" name="placeholder">
								</div>
								<div class="dropdown-form__required">
									<div class="dropdown-form__text">
										Required
									</div>
									<input type="checkbox" name="checkbox" id="dropdown-form__checkbox"> <label for="dropdown-form__checkbox"></label>
								</div>
							</div>
						</div>
					</li>
		        <li class="dropdown">
		          ...
		          <ul class="dropdown-menu">
						<li><a class="text-modify" href="#"><?php echo $categories[0];?></a></li>
						<li><a class="text-modify" href="#"><?php echo $categories[1];?></a></li>
						<li class="hover-ivent">
							<a class="text-modify " href="#">
								<?php echo $categories[2];?><span class="caret"></span>
							</a>
							<ul class="dropdovn-submenu">
							<?php 
						...
						<li><a class="text-modify" href="#"><?php echo $categories[3];?></a></li>
